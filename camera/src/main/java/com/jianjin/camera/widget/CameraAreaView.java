...
public class CameraAreaView extends View {
    ...
    public CameraAreaView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        cornerWidth = typedArray.getDimensionPixelOffset(R.styleable.CameraAreaView_corner_width,60);
        cornerLength = typedArray.getDimensionPixelOffset(R.styleable.CameraAreaView_corner_length,5);
        typedArray.recycle();
